...
function handleMermaidCannotLoad() {
  // ugly alert() for now I wonder what we want to do here? This could happen
  // for users with old browsers (although I have no idea what transpiling
  // Astro performs or how compatibility the mermaid library is).
  alert(
