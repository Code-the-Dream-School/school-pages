...
A note on style: The JavaScript below is one big file. In general, this is bad style. Instead,
you would segment the function into multiple JavaScript files, with appropriate import and export
statements.
