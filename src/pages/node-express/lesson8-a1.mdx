...
![Walkthrough of Postman environment intialization](/lesson8-postman-init.gif)
...
![Screenshot of setting a variable from the Postman environment](/lesson8-postman-env.png)
