...
<ReviewLessonButton link="/node-express/lesson5-m1" />
...
<WarningCallout title="Warning: Skip download">
<p>The instructor suggests that you download code via a link on johnsmilga.com. <strong>Don't do this.</strong></p>
<p>Just continue to work on the same git repository you initially forked and downloaded for this course, which is <code>node-express-course</code>. You do not need to move directories from this git repository.</p>
</WarningCallout>
