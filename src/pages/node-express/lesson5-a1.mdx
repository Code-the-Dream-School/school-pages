...
<WarningCallout title="Warning: Skip download">
  ...
  <p>
    Just continue to work on the same git repository you initially forked and
    downloaded for this course, which is <code>node-express-course</code>. You
    do not need to move directories from this git repository.
  </p>
</WarningCallout>
