...
<ReviewLessonButton link="/node-express/lesson14-m1" />
...
<p class="ml-8">
  You need to include the auth middleware in the <code>app.use</code>, because
  these are protected routes and the requester must be a logged on user.
</p>
