...
<ReviewLessonButton link="/node-express/lesson1-m1" />
...
<WarningCallout title="Careful!">
  <p>
    Please <strong>don't clone the original Code-the-Dream repository</strong>,
...
<WarningCallout title="Careful!">
  <p>
    ...
    <strong>not the Code-the-Dream-School main branch!</strong>
  </p>
</WarningCallout>
