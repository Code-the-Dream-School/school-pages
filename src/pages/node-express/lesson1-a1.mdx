...
<WarningCallout title="Careful!"
                text="Please don’t clone the original Code-the-Dream repository, as if you do that, you will not be able to push your work to Github."/>
...
<WarningCallout title="Careful!" text="The target of the pull request should be the main branch of the repository you created when you forked -- not the Code-the-Dream-School main branch!" />
...
<video controls title='Open a PR walkthrough' src='/submit-pr.mov' />
