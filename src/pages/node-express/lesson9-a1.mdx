...
<ReviewLessonButton link="/node-express/lesson9-m1" />
...
<WarningCallout title="Warning">
  <p>
    When you clone, make sure you are not inside the
    <code>node-express-course</code> folder, so that you keep this repository separate.
  </p>
</WarningCallout>
...
<WarningCallout title="Warning">
  <p>
    ...
    do the copy of the starter directory that is described by the instructor.
    <strong>
      <i>Do not</i>
    </strong>
    do the <code>git init</code>.
  </p>
</WarningCallout>
